# :gem: Automation API - REST API Testing
## :diamond_shape_with_a_dot_inside: Automated API tests created in Postman

## :information_source: About this project
The project was created to strengthen my API testing skills in Postman. Automated tests were developed for the test scenarios listed below. These tests were executed both directly within the Postman application and through the command‑line Collection Runner (Newman), which makes it possible to run and validate a Postman Collection from the terminal.
